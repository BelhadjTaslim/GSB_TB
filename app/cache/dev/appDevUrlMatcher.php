...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/36cbc85')) {
            // _assetic_36cbc85
            if ($pathinfo === '/css/36cbc85.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '36cbc85',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_36cbc85',);
            }

            // _assetic_36cbc85_0
            if ($pathinfo === '/css/36cbc85_bootstrap_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '36cbc85',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_36cbc85_0',);
            }
        ...
        // gsb_homepage_comptables
        if ($pathinfo === '/indexC') {
            return array (  '_controller' => 'Ahe\\gsbBundle\\Controller\\ComptableController::accueilComptablesAction',  '_route' => 'gsb_homepage_comptables',);
        }
